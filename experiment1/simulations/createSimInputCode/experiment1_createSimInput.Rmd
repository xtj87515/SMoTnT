...
### The scaled mRNA synthesis rates are calculated from previous trial simulations (exp11), based on both the synthesis rates and simulated mRNA count for the trial runs (exp11). The mRNA synthesis rates for trial simulations are solely calculated as mRNA decay rate*initial mRNA abundance.
```{r, include = FALSE}
