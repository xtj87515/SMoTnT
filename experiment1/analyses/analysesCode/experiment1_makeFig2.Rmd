...
figure2c <- allSimInputOutput %>%
  filter(paraCombo=="mRNAconstant"|paraCombo=="dc_1_r_0") %>%
...
figure2d <- allSimInputOutput %>%
  ...
  theme(text = element_text(size = 13),
      ...
      stat_cor(aes(label=paste(..r.label..,  sep = "~`,`~")), label.x.npc = 0.1, label.y.npc = 0.5, size=5) +
      scale_x_log10() +
      scale_y_log10() +
...
figure2e <- allSimInputOutput %>%
  ...
  theme(text = element_text(size = 13),
      ...
      stat_cor(aes(label=paste(..r.label..,  sep = "~`, `~")), label.x.npc = 0.2, label.y.npc = 0.3, size=5) +
